...
namespace National_Bank_of_Serbia {
    ...
    public partial class BankDataSet : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public UsersRow AddUsersRow(string Pin, string FirstName, string LastName, int Balance, string NationalID) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public UsersRow FindByPin(string Pin) {
        ...
        public partial class UsersRow : global::System.Data.DataRow {
            ...
            public string NationalID {
                get {
                    return ((string)(this[this.tableUsers.NationalIDColumn]));
                }
                set {
                    this[this.tableUsers.NationalIDColumn] = value;
                }
            }
        }
...
namespace National_Bank_of_Serbia.BankDataSetTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Users] WHERE (([Pin] = @Original_Pin) AND ([FirstName] = @Orig" +
                "inal_FirstName) AND ([LastName] = @Original_LastName) AND ([Balance] = @Original" +
                "_Balance) AND ([NationalID] = @Original_NationalID))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Users] ([Pin], [FirstName], [LastName], [Balance], [NationalID" +
                "]) VALUES (@Pin, @FirstName, @LastName, @Balance, @NationalID);\r\nSELECT Pin, Fir" +
                "stName, LastName, Balance, NationalID FROM Users WHERE (Pin = @Pin)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Users] SET [Pin] = @Pin, [FirstName] = @FirstName, [LastName] = @LastName, [Balance] = @Balance, [NationalID] = @NationalID WHERE (([Pin] = @Original_Pin) AND ([FirstName] = @Original_FirstName) AND ([LastName] = @Original_LastName) AND ([Balance] = @Original_Balance) AND ([NationalID] = @Original_NationalID));
SELECT Pin, FirstName, LastName, Balance, NationalID FROM Users WHERE (Pin = @Pin)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::National_Bank_of_Serbia.Properties.Settings.Default.con;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Pin, FirstName, LastName, Balance, NationalID FROM dbo.Users";
        ...
        public virtual int Delete(string Original_Pin, string Original_FirstName, string Original_LastName, int Original_Balance, string Original_NationalID) {
        ...
        public virtual int Insert(string Pin, string FirstName, string LastName, int Balance, string NationalID) {
            if ((Pin == null)) {
        ...
        public virtual int Update(string Pin, string FirstName, string LastName, int Balance, string NationalID, string Original_Pin, string Original_FirstName, string Original_LastName, int Original_Balance, string Original_NationalID) {
            if ((Pin == null)) {
                throw new global::System.ArgumentNullException("Pin");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[8].Value = ((int)(Original_Balance));
            if ((Original_NationalID == null)) {
                throw new global::System.ArgumentNullException("Original_NationalID");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string LastName, int Balance, string NationalID, string Original_Pin, string Original_FirstName, string Original_LastName, int Original_Balance, string Original_NationalID) {
            return this.Update(Original_Pin, FirstName, LastName, Balance, NationalID, Original_Pin, Original_FirstName, Original_LastName, Original_Balance, Original_NationalID);
        }
    }
